...
object Film{
  ...
  // add a method highestRating which has two films as parameters and returns the highest imdbRating of the two
  ...
  //add a method oldestDirectorAtTheTime which takes two films as parameters and returns the director who was
...
object Director{
  ...
  def older(director1: Director, director2: Director) =
    if(director1.yearOfBirth > director2.yearOfBirth) director2 else director1
}